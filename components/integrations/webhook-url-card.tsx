...
export function WebhookUrlCard({
  ...
  const testWebhook = async () => {
    ...
    if (isPreview) {
      setTestResult({
        ...
        status: 0,
        data: { 
          error: 'Preview Environment',
          message: 'Webhook testing is not available in the live preview. Deploy your app to test webhooks with real Supabase credentials.'
        },
        isPreview: true
      })
      ...
      toast({
        ...
        description: "Deploy your app to test webhooks with real credentials",
        variant: "destructive"
      })
      setTesting(false)
      return
  ...
  const getSetupInstructions = () => {
    if (platform === 'elementor') {
      return [
        "Open your Elementor form in edit mode on the LIVE site (not preview)",
                ...
                <div>
                  ...
                  {testResult.isPreview && (
                    <div className="mt-2 p-2 bg-blue-100 rounded text-sm">
                      <strong>To test with real data:</strong>
